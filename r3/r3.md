...
C 没有真正意义上的“多维数组”（[但 C++23 有多维下标运算符！！！](https://en.cppreference.com/w/cpp/language/operator_member_access)）
